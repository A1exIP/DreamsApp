...
//        });
        ...
        // Analysis
        Button analysis_button = (Button) findViewById(R.id.button_analysis); // Находим кнопку в макете по ее идентификатору
        analysis_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View activity_analysis) { // Устанавливаем обработчик нажатия кнопки
...
//        });
        ...
        calendar_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View button_calendar) { // Устанавливаем обработчик нажатия кнопки
                // Создаем новое намерение для перехода на другую активность
...
//        });
        ...
        target_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View button_target) { // Устанавливаем обработчик нажатия кнопки
                // Создаем новое намерение для перехода на другую активность
...
//        });
        ...
        account_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View button_account) { // Устанавливаем обработчик нажатия кнопки
                // Создаем новое намерение для перехода на другую активность
...
//        TextView editTextTask = findViewById(R.id.textView);
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View add_new) {
                addTask();
            }
        });
